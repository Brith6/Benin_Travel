...
"[project]/data/db.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/db.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function TripProvider({ children }) {
    const [tripData, setTripData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        region: null,
        hotel: null,
        activities: [],
        restaurants: []
    ...
    const setRegion = (regionId)=>{
        const region = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["regions"].find((r)=>r.id === regionId) || null;
    ...
    const setHotel = (hotelId)=>{
        const hotel = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HOTELS"].find((h)=>h.id === hotelId) || null;
        setTripData((prev)=>({
                ...prev,
                hotel
            }));
    ...
    const addActivity = (activityId)=>{
        const activity = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ACTIVITIES"].find((a)=>a.id === activityId);
    ...
    const addRestaurant = (restaurantId)=>{
        const restaurant = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RESTAURANTS"].find((r)=>r.id === restaurantId);
    ...
    const totalPrice = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useMemo(()=>{
        let total = 0;
        if (tripData.hotel) total += tripData.hotel.price;
        tripData.activities.forEach((a)=>total += a.price);
        tripData.restaurants.forEach((r)=>total += r.price);
        return total;
    }, [
        tripData
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01463444._.js.map