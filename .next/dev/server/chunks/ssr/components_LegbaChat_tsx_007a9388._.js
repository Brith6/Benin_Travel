module.exports = [
"[project]/components/LegbaChat.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const handleSend = ()=>{
        ...
        setTimeout(()=>{
            ...
            if (lowerInput.match(/\b(bonjour|salut|hello|hi|coucou)\b/)) {
                ...
                const spots = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db_master$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DB_MASTER"].filter((i)=>i.category === 'SPORT').slice(0, 3).map((i)=>i.name).join(', ');
                ...
                if (lowerInput.includes('ouidah')) {
                    const spots = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db_master$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DB_MASTER"].filter((i)=>i.category === 'HOTEL' && i.city === 'UIDAH').map((i)=>i.name).join(', ');
                    responseText = `À Ouidah, le repos est sacré. Regardez du côté de : ${spots}.`;
                } else if (lowerInput.includes('cotonou')) {
                    const spots = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db_master$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DB_MASTER"].filter((i)=>i.category === 'HOTEL' && i.city === 'COTONOU').map((i)=>i.name).join(', ');
                ...
                const roots = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db_master$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DB_MASTER"].filter((i)=>i.category === 'RESTAURANT' && i.vibe.includes('ROOTS')).slice(0, 2).map((i)=>i.name).join(', ');
                const luxe = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db_master$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DB_MASTER"].filter((i)=>i.category === 'RESTAURANT' && i.vibe.includes('LUXE')).slice(0, 2).map((i)=>i.name).join(', ');
                ...
                const spots = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db_master$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DB_MASTER"].filter((i)=>i.category === 'EVENT' || i.vibe.includes('FESTIVE')).slice(0, 3).map((i)=>i.name).join(', ');
                ...
                const spots = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$db_master$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DB_MASTER"].filter((i)=>i.category === 'CULTURE').slice(0, 3).map((i)=>i.name).join(', ');
...
//# sourceMappingURL=components_LegbaChat_tsx_007a9388._.js.map