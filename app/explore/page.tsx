...
import { Filter, Search, MapPin, Zap, DollarSign } from 'lucide-react';
      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8">
          <div>
            ...
            <p className="text-gray-400 max-w-lg">
              Le moteur de recherche intelligent du 229. Filtrez par ambiance, lieu et prix.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              ...
              {prices.map(p => <option key={p} value={p}>{'$'.repeat(p)}</option>)}
            </select>
          </div>
        </div>
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-20">
            ...
            <button
              onClick={() => { setFilterCategory('ALL'); setFilterVibe('ALL'); setFilterCity('ALL'); setFilterPrice('ALL'); }}
